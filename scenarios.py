...
def plot_power(pwr, colors, powerConsumers, powerStorage, powerGenerators, period=None, start=None, end=None):
        # Group
...
def plot_heat(power, heat, colors, heatGenerators, heatStorage, period=None, start=None, end=None):
    # Group
    if period is not None and start is None and end is None:
